...
import {
  ...
  getBookingByUserId,
  updateBookingStatus,
} from '../../modules/bookings/booking.controller.v2';
import UserMiddlewares from '../../modules/user/user.middlewares';
import { UserRole } from '../../interfaces/jwtPayload.interfaces';
import { multipleFilesUpload } from '../../utils/fileUploader';
...
router.post('/',multipleFilesUpload([
...
router.get(
  '/host/:id',
  checkAccessToken,
  allowRole(UserRole.Host, UserRole.Admin),
  getBookingByHostId
);
