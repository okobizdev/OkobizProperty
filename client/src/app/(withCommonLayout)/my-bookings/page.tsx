...
const MyBookingsPage = () => {
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      ...
      try {
        setLoading(true);
        const response = await BookingServices.getBookingsByUserId(user.userId, {
          page: currentPage,
          limit: itemsPerPage,
        });
    ...
    fetchBookings();
  }, [user?.userId, currentPage, isAuthenticated]);
                    ...
                    <div className="md:w-3/4 p-6">
                      <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-4">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                            ...
                            <span
                              className={`px-3 py-1 text-sm font-semibold rounded-full ${booking.propertyId?.listingType === "SELL"
                        ...
                        <div className="text-right">
                          <p className="text-3xl font-bold text-green-600 mb-1">
                            ...
                            {booking.propertyId?.priceUnit || "BDT"}
                          </p>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        ...
                        <div className="text-center">
                          ...
                          <p
                            className={`font-semibold capitalize ${booking.paymentStatus === "paid"
                                ? "text-green-600"
                                : "text-red-600"
                              }`}
                          >
                        ...
                        <div className="text-center">
                          ...
                          <p
                            className={`font-semibold capitalize ${booking.status === "confirmed"
                                ? "text-green-600"
                                : "text-primary"
                              }`}
                          >
                          ...
                          <div>
                            ...
                            <div className="space-y-1 text-sm">
                              ...
                              <p>
                                ...
                                {booking.propertyId?.publishStatus || "N/A"}
                              </p>
                            ...
                            <div className="space-y-1 text-sm">
                              ...
                              {booking.propertyId?.description && (
                                <p>
                                  ...
                                  {booking.propertyId.description.length > 100 && "..."}
                                </p>
                              )}
                            </div>
                          </div>
